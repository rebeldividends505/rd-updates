...
const TICKERS = {
  ...
  MU: { name: "Micron", archetype: "Cyclical peak — memory", ytd: "≈ +130–170%", ytdProv: "u",
    ...
    signals: [
      { group: "Tier 1 — pricing", name: "Cycle pricing roll (see macro chain)", weight: 3, reading: "Contract decel starting; spot firm", status: "watch", prov: "v", source: "TrendForce", trigger: "Spot turns / contract goes flat" },
      { group: "Tier 1 — pricing", name: "Gross-margin direction", weight: 3, reading: "Guide ~81% — near peak", status: "intact", prov: "r", source: "MU earnings", trigger: "First sequential decline off peak" },
      { group: "Tier 2 — supply", name: "Industry capex (big-3)", weight: 2, reading: "MU ~$20B FY26; all three ramping", status: "watch", prov: "v", source: "MU/Samsung/SK Hynix", trigger: "Capex up = oversupply in 18–24 mo" },
      { group: "Tier 2 — supply", name: "Days of inventory", weight: 2, reading: "Lean / tight", status: "intact", prov: "u", source: "MU 10-Q", trigger: "Inventory days rising" },
      { group: "Tier 2 — supply", name: "HBM sold-out erosion", weight: 2, reading: "Sold out 2026", status: "intact", prov: "v", source: "earnings", trigger: "Bookings loosen" },
      { group: "Tier 3 — valuation trap", name: "P/E on PEAK earnings", weight: 2, reading: "Fwd P/E ~8x on peak EPS — classic top setup", status: "watch", prov: "v", source: "market data", trigger: "Single-digit P/E on peak = SELL tell" },
    ],
    seed: {
      ytd:{reading:"≈ +130–170%",status:"watch",prov:"u"}, ma200:{reading:"Well extended",status:"watch",prov:"u"},
      issuance:{reading:"None recent",status:"intact",prov:"u"}, target:{reading:"Below Street targets (upgrades ongoing)",status:"intact",prov:"u"},
      si:{reading:"Moderate",status:"intact",prov:"u"}, react:{reading:"Gapped up on last print",status:"intact",prov:"u"} } },
  ...
  NVDA: { name: "NVIDIA", archetype: "Secular growth — GPU", ytd: "≈ +18–20%", ytdProv: "u",
    thesis: "Concentrated grower. Needs demand decel + margin crack + multiple compression. Squeeze-prone — prefer defined-risk options.",
    key: "Trio: hyperscaler capex revision + DC sequential growth + gross margin.",
    signals: [
      { group: "Tier 1 — thesis", name: "Data-center seq. growth", weight: 3, reading: "+20% QoQ (Q1 FY27)", status: "intact", prov: "r", source: "NVDA earnings", trigger: "Sequential growth decelerating" },
      { group: "Tier 1 — thesis", name: "Gross margin trend", weight: 3, reading: "74.9%; Q2 guide 75% — stable", status: "intact", prov: "r", source: "NVDA earnings", trigger: "Sustained compression off ~75%" },
      { group: "Tier 2 — confirming", name: "Inventory + commitments", weight: 2, reading: "Inv $25.8B (was $21.4B); commits $119B", status: "watch", prov: "r", source: "10-Q", trigger: "Inventory builds faster than rev" },
      { group: "Tier 2 — confirming", name: "Vendor-financing loop", weight: 2, reading: "~$73B portfolio; $18.6B/qtr; $15.9B equity gains", status: "watch", prov: "r", source: "10-Q + customer filings", trigger: "Financed customer stumbles" },
      { group: "Tier 2 — confirming", name: "Custom-ASIC share", weight: 2, reading: "TPU/Trainium growing; 'not yet meaningful'", status: "intact", prov: "v", source: "hyperscaler disclosures", trigger: "Measurable share loss" },
      ...
      { group: "Tier 3 — positioning", name: "Insider selling", weight: 1, reading: "$3.3B/18mo, zero buys — but 10b5-1", status: "watch", prov: "v", source: "Form 4", trigger: "Acceleration / non-10b5-1 sales" },
      { group: "Tier 3 — positioning", name: "Expectations vs guide", weight: 1, reading: "Street pulled above company guide (first time)", status: "watch", prov: "v", source: "consensus", trigger: "Unmeetable bar set" },
    ],
    seed: {
      ytd:{reading:"≈ +18–20% YTD (gone sideways 6mo)",status:"intact",prov:"u"}, ma200:{reading:"Near trend; not extended",status:"intact",prov:"u"},
      issuance:{reading:"None",status:"intact",prov:"u"}, target:{reading:"Below Street targets",status:"intact",prov:"u"},
      si:{reading:"Low float-relative SI; squeeze monster",status:"watch",prov:"u"}, react:{reading:"Beat-and-fade: lower on 4 of last 5",status:"watch",prov:"v"} } },
  ...
  AMD: { name: "AMD", archetype: "Secular growth — GPU challenger", ytd: "verify", ytdProv: "u",
    ...
    signals: [
      { group: "Tier 1 — thesis", name: "MI-series share / wins", weight: 3, reading: "—", status: "na", prov: "u", source: "earnings", trigger: "Socket wins disappoint" },
      { group: "Tier 1 — thesis", name: "Gross margin", weight: 2, reading: "—", status: "na", prov: "u", source: "earnings", trigger: "Compression" },
    ],
    seed: {
      ytd:{reading:"verify",status:"na",prov:"u"}, ma200:{reading:"—",status:"na",prov:"u"},
